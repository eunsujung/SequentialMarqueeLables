...
@protocol MarqueeLabelDeleagete <NSObject>
-(void)didEndScroll:(id)obj;
-(void)didStartScroll:(id)obj;
@end
...
/**
 ...
 @code
 MarqueeLabel *lengthyLabel = [[MarqueeLabel alloc] initWithFrame:CGRectMake(100, 200, 100, 50)
 duration:4.0
 andFadeLength:0.0f];
 [lengthyLabel setAnimationDelay:2.0];
 [lengthyLabel setText:@"Start scroll Start scroll Start scroll End scroll "];
...
@property(nonatomic, retain) NSString *tclButtonId;
@property(nonatomic, weak) id <MarqueeLabelDeleagete> delegate;
@property(nonatomic, retain) NSString  *m_strButtonID;
